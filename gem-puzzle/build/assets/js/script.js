...
/* harmony import */ var _modules_puzzle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/puzzle */ "./app/assets/js/modules/puzzle.js");

window.addEventListener('DOMContentLoaded', function () {
  new _modules_puzzle__WEBPACK_IMPORTED_MODULE_0__["default"]().init();
});
...
var Puzzle = /*#__PURE__*/function () {
  function Puzzle(classes) {
    ...
    this.moves = 0;
    this.initialTime = 0; // this.time = '00:00:00';
  ...
  _createClass(Puzzle, [{
    ...
    value: function init() {
      ...
      this.numbers = this.generateRandomArray(Math.pow(this.size, 2));
      this.sortedNumbers = _toConsumableArray(this.numbers).sort(function (a, b) {
        return a - b;
      });
      this.render();
      this.updateTime();
      this.moveField.textContent = "".concat(this.moves);
      this.modeDropdown.addEventListener('click', function (e) {
        var _iterator = _createForOfIteratorHelper(e.target.childNodes),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (node.selected === true) {
              _this.selectMode(+node.dataset.size);
            }
          }
        } catch (err) {
          _iterator.e(err);
      ...
      this.grid.addEventListener('click', function (e) {
        _this.removeItems('button');

        var targetIndex = _this.numbers.findIndex(function (num) {
          return num === +e.target.textContent;
        });

        var zeroIndex = _this.numbers.findIndex(function (num) {
          return num === 0;
        });

        var top = zeroIndex - _this.size < 0 ? null : zeroIndex - _this.size;
        var right = (zeroIndex + 1) % _this.size === 0 ? null : zeroIndex + 1;
        var bottom = zeroIndex + _this.size >= Math.pow(_this.size, 2) ? null : zeroIndex + _this.size;
        var left = (zeroIndex + 1) % _this.size === 1 ? null : zeroIndex - 1;
        var idx = [top, right, left, bottom];

        for (var i = 0; i < idx.length; i++) {
          if (targetIndex === idx[i]) {
            if (e.target.nodeName === 'BUTTON') {
              _this.moves += 1;
              _this.moveField.textContent = "".concat(_this.moves);

              _this.playSound(_this.sound);
            }

            _this.numbers[zeroIndex] = _this.numbers[targetIndex];
            _this.numbers[targetIndex] = 0;
          }
        }

        _this.generateItems(_this.numbers);

        var numStr = _toConsumableArray(_this.numbers).join('');

        var sortedNumStr = [].concat(_toConsumableArray(_this.sortedNumbers.slice(1)), [_this.sortedNumbers[0]]).join('');

        if (numStr === sortedNumStr) {
          _this.isGameOver = true;

          _this.openMenu(_this.menuTrigger, _this.menu);

          _this.showGameOver(_this.time, _this.moves);

          _this.menu.append(_this.gameOverScreen);
          ...
          var result = {
            ...
            moves: "".concat(_this.moves),
            size: "".concat(_this.size, "x").concat(_this.size)
          };
      ...
      this.listItems.forEach(function (item) {
        return item.addEventListener('click', function (e) {
          return _this.routeMenu(e);
        });
      });
      this.saveBtn.addEventListener('click', function (e) {
        return _this.saveGame(e);
      });
    ...
    key: "openMenu",
    value: function openMenu(item, menu) {
      item.textContent = 'Resume game';
      menu.style.display = 'flex';
    }
  }, {
    key: "closeMenu",
    value: function closeMenu(item, menu) {
    ...
    key: "showScreen",
    value: function showScreen(el, parent, activeClass) {
    ...
    value: function generateRandomArray(length) {
      return Array.from(new Array(length).keys()).sort(function () {
    ...
    value: function resetGame() {
      ...
      this.grid.style.gridTemplateColumns = "repeat(".concat(this.size, ", 1fr)");
      this.grid.style.gridTemplateRows = "repeat(".concat(this.size, ", 1fr)");
      ...
      var _this$time3 = this.time,
          hours = _this$time3.hours,
          minutes = _this$time3.minutes,
          seconds = _this$time3.seconds;
      this.moves = 0;
      this.timeField.textContent = "".concat(hours, ":").concat(minutes, ":").concat(seconds);
      this.moveField.textContent = "".concat(this.moves);
      this.generateItems(this.numbers);
    }
  }, {
    key: "generateItems",
    value: function generateItems(arr) {
      var _this3 = this;

      if (arr && arr.length) {
        return arr.map(function (number) {
          return new _cell__WEBPACK_IMPORTED_MODULE_17__["default"]({
            parent: _this3.grid,
            value: "".concat(number),
            ticks: _this3.ticks,
            field: _this3.moveField
          }).init();
        });
      }
    }
    ...
    value: function updateTime() {
      ...
      this.intervalId = setInterval(function () {
        if (_this4.isActive) {
          ...
          _this4.timeField.textContent = "".concat(hours, ":").concat(minutes, ":").concat(seconds);
        }
      }, 1000);
    ...
    key: "removeItems",
    value: function removeItems(selector) {
    ...
    key: "saveGame",
    value: function saveGame(e) {
      var _this5 = this;

      e.preventDefault();
      this.message.textContent = 'Game saved!';
      setTimeout(function () {
        _this5.message.textContent = 'Do you want to save the game?';
    ...
    key: "playSound",
    value: function playSound(audio) {
      if (!audio) {
        return;
      }
    ...
    key: "showGameOver",
    value: function showGameOver(time, moves) {
...
/***/ "./app/assets/js/services/create.js":
/*!******************************************!*\
  !*** ./app/assets/js/services/create.js ***!
  \******************************************/
/*! exports provided: default */
...
function create(tag, selectors, value, children) {
  var element = document.createElement(tag);

  if (selectors) {
    var classes = selectors.classes,
        attributes = selectors.attributes;
...
/*!********************************************!*\
  !*** ./app/assets/js/services/services.js ***!
  \********************************************/
/*! exports provided: addZero, setCorrectNum */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addZero", function() { return addZero; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setCorrectNum", function() { return setCorrectNum; });
var addZero = function addZero(num) {
  return num < 10 ? "0".concat(num) : "".concat(num);
};
var setCorrectNum = function setCorrectNum(num, max) {
  return +num > max ? '00' : "".concat(num);
};

/***/ }),

/***/ "./app/assets/js/services/storage.js":
/*!*******************************************!*\
  !*** ./app/assets/js/services/storage.js ***!
  \*******************************************/
