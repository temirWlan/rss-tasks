...
var Cell = /*#__PURE__*/function () {
  function Cell(_ref) {
    ...
    // debugger;
    this.parent = parent; // this.item = +value ? create('button', null, value) : null;
  ...
  _createClass(Cell, [{
    ...
    value: function addEventHandlers() {// this.parent.addEventListener('click', () => {
      // 	this.countTicks();
      // });
    }
  }]);
    ...
    value: function init() {
      ...
      this.grid.addEventListener('click', function (e) {
        ...
        var zeroIndex = _this.numbers.findIndex(function (num) {
          return num === 0;
        }); // if (targetIndex === zeroIndex - 1 || targetIndex === zeroIndex + 1) {
